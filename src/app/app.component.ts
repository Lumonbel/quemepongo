...
VerprendaComponent } from './components/verprenda/verprenda.component';
...
@Component({
  selector: 'app-root',
  imports: [FormularioComponent, FooterComponent, VerprendaComponent, ComponentepruebaComponent, UsuarioComponent, IndexComponent, LoginComponent, FormularioPasosComponent, RouterOutlet, BtAtrasComponent, MenuComponent, InicioClienteComponent],
